#ifndef __LOADER_MACHO_PATCHER_TRAITS_HPP__
#define __LOADER_MACHO_PATCHER_TRAITS_HPP__
#pragma once
...
/// Mach-O patcher traits — not yet implemented.
struct MachOPatcherTraits {
...
#endif  // __LOADER_MACHO_PATCHER_TRAITS_HPP__
