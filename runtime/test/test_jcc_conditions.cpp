/// @file test_jcc_conditions.cpp
/// @brief Tests for all JCC condition codes (taken and not-taken paths).
///
/// CMP sets flags: ZF (bit 0), SF (bit 1), CF (bit 2), OF (bit 3).
/// evaluate_condition maps condition codes 0-9 to flag predicates.
/// Conditions 10-13 (S, NS, O, NO) hit the default case and return false.
...
TEST(JccConditions, EQ_NotTaken) {
...
TEST(JccConditions, NE_NotTaken) {
...
TEST(JccConditions, LT_NotTaken) {
...
TEST(JccConditions, GE_NotTaken) {
...
TEST(JccConditions, LE_Taken_Equal) {
...
TEST(JccConditions, LE_Taken_Less) {
...
TEST(JccConditions, LE_NotTaken) {
...
TEST(JccConditions, GT_NotTaken_Equal) {
...
TEST(JccConditions, GT_NotTaken_Less) {
...
TEST(JccConditions, AE_NotTaken) {
...
TEST(JccConditions, BE_Taken_Below) {
...
TEST(JccConditions, BE_Taken_Equal) {
...
TEST(JccConditions, BE_NotTaken) {
...
TEST(JccConditions, A_NotTaken_Equal) {
...
TEST(JccConditions, A_NotTaken_Below) {
...
TEST(JccConditions, S_AlwaysFallthrough) {
...
TEST(JccConditions, NO_AlwaysFallthrough) {
