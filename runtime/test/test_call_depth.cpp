/// @file test_call_depth.cpp
/// @brief Tests for CALL_VM/RET_VM nesting and shadow stack.
///
/// Tests: 2-level nesting, 8-level (max shadow), overflow (9th), register preservation.
...
// ============================================================================
// Test 2: 3-level nested call
//   BB1: r0=10, CALL→BB2, HALT
//   BB2: r0=20, CALL→BB3, RET
//   BB3: r0=30, RET
// ============================================================================

TEST(CallDepth, ThreeLevelNested) {
    uint8_t seed[32]; fill_seed(seed);
...
// ============================================================================
// Test 3: Shadow stack overflow (9th CALL exceeds VM_MAX_NESTING=8)
// ============================================================================

TEST(CallDepth, ShadowStackOverflow) {
    uint8_t seed[32]; fill_seed(seed);
...
// ============================================================================
// Test 4: 8-level nesting (max shadow, should succeed)
// ============================================================================

TEST(CallDepth, MaxNestingSucceeds) {
    uint8_t seed[32]; fill_seed(seed);
...
// ============================================================================
// Test 5: Register preservation across CALL_VM
// ============================================================================

TEST(CallDepth, RegisterPreservation) {
    uint8_t seed[32]; fill_seed(seed);
